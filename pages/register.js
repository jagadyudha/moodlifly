...
const Register = () => {
  ...
  return (
    <>
      <NextSeo
        title="Registrasi - Moodlify"
        description="Registrasi untuk melakukan test gangguan kecemasan gratis"
      />
      <section>
        {success && (
          <>
            <div className="modal modal-open">
              <title>MOODLIFY - Registrasi</title>
          ...
          <div className=" mb-5 ">
            ...
            <div className=" mt-2">
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, nama_depan: e.target.value })
                }
              />
            </div>
          </div>
